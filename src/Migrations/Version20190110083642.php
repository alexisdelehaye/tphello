 ...
 */
final class Version20190110083642 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE weapon (id INT AUTO_INCREMENT NOT NULL, weapon_user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, damage NUMERIC(100, 2) DEFAULT NULL, INDEX IDX_6933A7E625993D1 (weapon_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE weapon_user (id INT AUTO_INCREMENT NOT NULL, weapon_id INT DEFAULT NULL, user_id INT DEFAULT NULL, quality INT DEFAULT NULL, ammunition INT DEFAULT NULL, active TINYINT(1) NOT NULL, INDEX IDX_358C3EB695B82273 (weapon_id), INDEX IDX_358C3EB6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE weapon ADD CONSTRAINT FK_6933A7E625993D1 FOREIGN KEY (weapon_user_id) REFERENCES weapon_user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE weapon DROP FOREIGN KEY FK_6933A7E625993D1');
