 ...
 */
final class Version20190110083709 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE weapon (id INT AUTO_INCREMENT NOT NULL, weapon_user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, damage NUMERIC(65, 2) DEFAULT NULL, INDEX IDX_6933A7E625993D1 (weapon_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
