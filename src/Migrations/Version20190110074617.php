 ...
 */
final class Version20190110074617 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD first_name VARCHAR(255) DEFAULT NULL, ADD last_name VARCHAR(255) DEFAULT NULL, ADD health INT DEFAULT NULL, DROP max_weight');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD max_weight INT NOT NULL, DROP first_name, DROP last_name, DROP health');
    }
}
