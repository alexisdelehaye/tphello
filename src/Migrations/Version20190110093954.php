 ...
 */
final class Version20190110093954 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6933A7E625993D1 ON weapon');
        $this->addSql('ALTER TABLE weapon DROP weapon_user_id, CHANGE damage damage NUMERIC(65, 2) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lecture (id INT AUTO_INCREMENT NOT NULL, chapitre_id INT DEFAULT NULL, user_id INT DEFAULT NULL, histoire_id INT DEFAULT NULL, date_lecture DATETIME NOT NULL, num_sequence INT NOT NULL, INDEX IDX_C1677948A76ED395 (user_id), INDEX IDX_C16779489B94373 (histoire_id), INDEX IDX_C16779481FBEEF7B (chapitre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE weapon ADD weapon_user_id INT DEFAULT NULL, CHANGE damage damage NUMERIC(65, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE weapon ADD CONSTRAINT FK_6933A7E625993D1 FOREIGN KEY (weapon_user_id) REFERENCES weapon_user (id)');
        $this->addSql('CREATE INDEX IDX_6933A7E625993D1 ON weapon (weapon_user_id)');
    }
}
